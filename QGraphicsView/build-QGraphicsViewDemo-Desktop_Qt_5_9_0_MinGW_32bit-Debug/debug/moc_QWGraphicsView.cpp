...
#include "../../QGraphicsViewDemo/QWGraphicsView.h"
...
QT_MOC_LITERAL(1, 15, 20), // "mouseMovePointSignal"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 5), // "point"
QT_MOC_LITERAL(4, 43, 18) // "mouseClickedSignal"

    },
    "QWGraphicsView\0mouseMovePointSignal\0"
    "\0point\0mouseClickedSignal"
};
...
void QWGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseMovePointSignal((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: _t->mouseClickedSignal((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QWGraphicsView::mouseMovePointSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QWGraphicsView::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QWGraphicsView::mouseClickedSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void QWGraphicsView::mouseMovePointSignal(QPoint _t1)
{
...
// SIGNAL 1
void QWGraphicsView::mouseClickedSignal(QPoint _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
